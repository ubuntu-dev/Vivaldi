...
vv_object_ptr_t vv_call_func(vv_object_ptr_t func,
                             vv_object_ptr_t* args,
                             size_t argc);

vv_object_ptr_t vv_get_mem(vv_object_ptr_t obj, vv_symbol_t name);
vv_object_ptr_t vv_set_mem(vv_object_ptr_t obj,
                           vv_symbol_t name,
                           vv_object_ptr_t val);
...
extern vv_object_ptr_t vv_builtin_type_array;
extern vv_object_ptr_t vv_builtin_type_array_iterator;
extern vv_object_ptr_t vv_builtin_type_bool;
extern vv_object_ptr_t vv_builtin_type_dictionary;
extern vv_object_ptr_t vv_builtin_type_file;
extern vv_object_ptr_t vv_builtin_type_float;
extern vv_object_ptr_t vv_builtin_type_function;
extern vv_object_ptr_t vv_builtin_type_int;
extern vv_object_ptr_t vv_builtin_type_nil;
extern vv_object_ptr_t vv_builtin_type_range;
extern vv_object_ptr_t vv_builtin_type_regex;
extern vv_object_ptr_t vv_builtin_type_string;
extern vv_object_ptr_t vv_builtin_type_string_iterator;
extern vv_object_ptr_t vv_builtin_type_symbol;
...
vv_object_ptr_t vv_new_int(int quant);
vv_object_ptr_t vv_new_nil(void);
...
vv_object_ptr_t vv_add_monop(vv_object_ptr_t type,
                          const char* name,
                          vv_object_ptr_t(*monop)(vv_object_ptr_t));
vv_object_ptr_t vv_add_binop(vv_object_ptr_t type,
                          const char* name,
                          vv_object_ptr_t(*binop)(vv_object_ptr_t,
                                                  vv_object_ptr_t));
